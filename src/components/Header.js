      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-lg bg-white/90 border-b border-gray-200">
          ...
          <div className="max-w-7xl mx-auto px-10 py-6 flex items-center justify-between">
            ...
            <button 
              ...
              className="hidden md:block group relative px-6 py-2 bg-[#5dd62c] hover:bg-[#337418] rounded-full font-semibold overflow-hidden transition-all hover:scale-105 shadow-lg hover:shadow-xl"
            >
