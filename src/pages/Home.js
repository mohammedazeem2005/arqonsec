...
const Home = () => {
    ...
    return (
      <div className="">
        ...
        <div className='flex flex-col lg:flex-row min-h-screen items-center justify-center gap-12 px-6'>
          <section className="relative flex items-center justify-center pt-20 z-10 flex-1">
            <div className="max-w-5xl mx-auto text-center lg:text-left">
              ...
              <h1 className='text-[#5dd62c] text-3xl md:text-4xl lg:text-6xl font-extrabold mb-6 leading-tight bg-clip-text  animate-fade-in'> Fort Knox</h1>
        ...
        <div className=''>
          <section className="relative flex items-center justify-center z-10 ">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <h1 className="text-[#5dd62c] text-3xl md:text-4xl lg:text-4xl font-extrabold leading-tight bg-clip-text animate-fade-in mt-3">
                Every{" "}
                <span
